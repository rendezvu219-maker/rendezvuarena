...
const UI_EXTRA = Object.freeze({
  "en": {
    ...
    "registrationModeTeamOrSolo": "Team selection + optional Solo Pool",
    "registrationModeSoloOnly": "Solo Pool only",
    "soloPoolLabel": "Registration destination",
    "soloOnlyJoinNotice": "Everyone enters the shared Solo Pool. The Host forms teams after approving registrations.",
    "soloOnlyJoinStep": "Submit as a player or self-nominated Captain to the shared Solo Pool.",
    ...
    "soloRandomizerDesc": "Preview equal private teams from approved, teamless signups. Confirmation fills existing targets or creates new teams; previewing alone saves nothing.",
    "teamFormationTarget": "Team destinations",
    "useExistingEmptyTeams": "Use {count} existing empty teams",
    "createNewSoloTeams": "Create new Solo Teams",
    "existingTeamTargetHelp": "The number of empty target teams must equal total slots divided by team size.",
    ...
    "randomCaptains": "Random (Host can reassign later)",
  ...
  "ja": {
    ...
    "registrationModeTeamOrSolo": "チーム選択＋任意の個人参加プール",
    "registrationModeSoloOnly": "個人参加プールのみ",
    "soloPoolLabel": "登録先",
    "soloOnlyJoinNotice": "全員が共通の個人参加プールに入り、Hostが承認後にチームを編成します。",
    "soloOnlyJoinStep": "プレイヤーまたは自己推薦キャプテンとして共通の個人参加プールに申請します。",
    ...
    "soloRandomizerDesc": "承認済みでチーム未所属の参加者から均等な非公開チームをプレビューします。確定すると既存の割り当て先を埋めるか新規チームを作成し、プレビューだけでは保存されません。",
    "teamFormationTarget": "割り当て先チーム",
    "useExistingEmptyTeams": "既存の空チーム {count}件を使用",
    "createNewSoloTeams": "新しい個人参加チームを作成",
    "existingTeamTargetHelp": "空の割り当て先チーム数は、総枠数をチーム人数で割った数と一致する必要があります。",
  ...
  "zh-CN": {
    ...
    "registrationMode": "报名模式",
    "registrationModeTeamOrSolo": "选择队伍＋可选个人池",
    "registrationModeSoloOnly": "仅个人池",
    "soloPoolLabel": "报名去向",
    "soloOnlyJoinNotice": "所有人进入共享个人池，由主办方审核后组队。",
    "soloOnlyJoinStep": "以选手或自荐队长身份提交至共享个人池。",
    ...
    "soloRandomizerDesc": "从已批准且未入队的报名中预览人数相等的私密队伍；确认后填入现有目标队伍或新建队伍，预览本身不会保存。",
    "teamFormationTarget": "目标队伍",
    "useExistingEmptyTeams": "使用 {count} 支现有空队伍",
    "createNewSoloTeams": "新建个人报名队伍",
    "existingTeamTargetHelp": "空目标队伍数必须等于总名额除以每队人数。",
  ...
  "ko": {
    ...
    "registrationMode": "등록 모드",
    "registrationModeTeamOrSolo": "팀 선택＋선택적 개인 풀",
    "registrationModeSoloOnly": "개인 풀 전용",
    "soloPoolLabel": "등록 대상",
    "soloOnlyJoinNotice": "모든 참가자가 공용 개인 풀에 들어가며 Host가 승인 후 팀을 구성합니다.",
    "soloOnlyJoinStep": "플레이어 또는 자원 주장으로 공용 개인 풀에 신청합니다.",
    ...
    "soloRandomizerDesc": "승인된 무소속 참가자로 같은 인원의 비공개 팀을 미리 봅니다. 확정하면 기존 대상 팀을 채우거나 새 팀을 만들며, 미리 보기만으로는 저장되지 않습니다.",
    "teamFormationTarget": "배정 대상 팀",
    "useExistingEmptyTeams": "기존 빈 팀 {count}개 사용",
    "createNewSoloTeams": "새 개인 참가 팀 만들기",
    "existingTeamTargetHelp": "빈 대상 팀 수는 전체 슬롯을 팀 인원으로 나눈 값과 같아야 합니다.",
    ...
    "randomCaptains": "무작위 배정 (이후 변경 가능)",
  ...
  "es": {
    ...
    "registrationModeTeamOrSolo": "Elegir equipo＋grupo individual opcional",
    "registrationModeSoloOnly": "Solo grupo individual",
    "soloPoolLabel": "Destino de inscripción",
    "soloOnlyJoinNotice": "Todos entran al grupo individual compartido. El Host forma los equipos después de aprobar las inscripciones.",
    "soloOnlyJoinStep": "Inscríbete como jugador o Capitán autonominado en el grupo individual compartido.",
    ...
    "soloRandomizerDesc": "Previsualiza equipos privados y equilibrados con inscripciones aprobadas sin equipo. Al confirmar se llenan los equipos existentes o se crean nuevos; la vista previa no guarda nada.",
    "teamFormationTarget": "Equipos de destino",
    "useExistingEmptyTeams": "Usar {count} equipos vacíos existentes",
    "createNewSoloTeams": "Crear nuevos equipos individuales",
    "existingTeamTargetHelp": "La cantidad de equipos vacíos debe ser igual a las plazas totales divididas por el tamaño del equipo.",
    ...
    "randomCaptains": "Aleatorio (el Host puede reasignar)",
  ...
  "vi": {
    ...
    "registrationMode": "Chế độ đăng ký",
    "registrationModeTeamOrSolo": "Chọn đội + Solo Pool tùy chọn",
    "registrationModeSoloOnly": "Chỉ Solo Pool",
    "soloPoolLabel": "Nơi nhận đăng ký",
    "soloOnlyJoinNotice": "Mọi người vào chung Solo Pool. Host duyệt xong mới tiến hành chia đội.",
    "soloOnlyJoinStep": "Đăng ký với vai trò người chơi hoặc tự ứng cử Đội trưởng vào Solo Pool chung.",
    ...
    "soloRandomizerDesc": "Xem trước các đội có quân số bằng nhau từ những đăng ký đã duyệt nhưng chưa có đội. Khi xác nhận, hệ thống điền vào đội có sẵn hoặc tạo đội mới; xem trước không lưu gì.",
    "teamFormationTarget": "Đội nhận người",
    "useExistingEmptyTeams": "Dùng {count} đội trống có sẵn",
    "createNewSoloTeams": "Tạo các Solo Team mới",
    "existingTeamTargetHelp": "Số đội trống phải bằng tổng số người chia cho quân số mỗi đội.",
    ...
    "randomCaptains": "Random ngẫu nhiên (tự đổi sau)",
